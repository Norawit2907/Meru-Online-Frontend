        ...
        <div className="mb-10 flex flex-col gap-6 px-4 lg:px-0">
            ...
            <div className="flex flex-wrap lg:flex-nowrap gap-6 justify-center lg:justify-start">
                ...
                {addonList.map((addon, index) => (
                    ...
                    >
                        <div
                            className="h-[100px] sm:h-[180px] lg:h-[225px] bg-cover bg-no-repeat rounded-t-[8px] lg:rounded-t-[25px]"
                            style={{ backgroundImage: `url(${addon.imageUrl})` }}
                        ></div>
                        <div className="mx-[12px] sm:mx-[15px] lg:mx-[20px] mt-2 h-[100px] sm:h-[100px] lg:h-[117px]">
