            ...
            <div class="registerbox">
              ...
              <form action="#" method="POST" className='flex flex-col mt-2 gap-y-4'>
                <div className="flex flex-col">
                  <label for="username"><FontAwesomeIcon icon={faUser}></FontAwesomeIcon> Username</label>
                  <input type="text" id="username" name="username" className="w-full bg-[#2d2d2e] p-2 rounded-xl border border-slate-600 text-white" required></input>
                </div>
                ...
                <div>
                  <label for="phone"><FontAwesomeIcon icon={faPhone}></FontAwesomeIcon> Telephine No.</label>
                  <input type="tel" id="phone" name="phone" className="w-full bg-[#2d2d2e] p-2 rounded-xl border border-slate-600 text-white" required></input>
                </div>
